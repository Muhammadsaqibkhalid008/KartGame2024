...
namespace PowerslideKartPhysics
{
    ...
    public class InputManager : MonoBehaviour
    {
        ...
        public void SetAccelMobile(float accel)
        {
            ...
            mobileAccel = accel;
            // GetComponent<KartSoundManager>().PlayKartEngineSound();
        }
        public static float mobileAccel;
        public static float mobileBrake;
        public static float GetMobileAccel() => mobileAccel;
        public static float GetMobileBrake() => mobileBrake;
        ...
        public void SetBrakeMobile(float brake)
        {
            ...
            mobileBrake = brake;
            // GetComponent<KartSoundManager>().StopKartEngineSound();
        }
        ...
        public void SetSteerMobile(float steer)
        {
            ...
            this.mobileSteer = steer;
        }

        public float GetMobileSteer() => this.mobileSteer;
